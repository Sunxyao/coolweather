...
public class TwoWeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_twoweather);
        weatherLayout = (ScrollView) findViewById(R.id.weather_layout);
        titleCity = (TextView) findViewById(R.id.title_city);
        titleUpdateTime = (TextView) findViewById(R.id.title_update_time);
        degreeText = (TextView) findViewById(R.id.degreez_text);
    ...
    private void loadBingPic() {
        ...
        HttpUtil.sendOkHttpRequest(requestBingPic, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(TwoWeatherActivity.this).edit();
                editor.putString("bing_pic",bingPic);
                editor.apply();
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Glide.with(TwoWeatherActivity.this).load(bingPic).into(bingPicImg);
                    }
                });
            }
        });
        ...
        HttpUtil.sendOkHttpRequest(weatherUri, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(TwoWeatherActivity.this, "获取天气信息失败", Toast.LENGTH_SHORT).show();
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (weather !=null && "ok".equals(weather.status)){
                            ...
                            editor.apply();
                            showWeatherInfo(weather);
                            Intent intent = new Intent(TwoWeatherActivity.this, AutoUpdateService.class);
                            startService(intent);
                        }else{
                            Toast.makeText(TwoWeatherActivity.this, "获取天气信息失败", Toast.LENGTH_SHORT).show();
                        }
